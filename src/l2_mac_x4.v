// GENERATED by gen_rtl.py -- do not edit by hand.
// L2 accumulate step, P=4 hidden unit(s) per cycle.
// P=1 is the shipped value-serial design (32 cycles); P>1 is lever B1.
module l2_mac_x4 (
    input  wire [15:0]  h_in,     // 4 x 4 b unsigned activations
    input  wire [79:0]  w_in,     // 4 x 20 b W2 trits ({p,n} per class)
    input  wire [119:0]   acc_in,   // 10 x 12 b signed out-ACC
